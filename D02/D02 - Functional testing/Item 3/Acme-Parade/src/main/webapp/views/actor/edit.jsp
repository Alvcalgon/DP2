	...
	<fieldset>
 	...
 	<jstl:choose>
		...
		<jstl:when test="${rol == 'Brotherhood'}">
			...
			<input type="submit" name="deleteBrotherhood" value="<spring:message code="actor.delete"/>" onclick="return confirm('<spring:message code="actor.confirm.delete"/>')"/>
		</jstl:when>
		<jstl:when test="${rol == 'Member'}">
			<acme:submit name="saveMember" code="actor.save" onclick="javascript: return checkTelephone('${confirmTelephone}');"/>
			<input type="submit" name="deleteMember" value="<spring:message code="actor.delete"/>" onclick="return confirm('<spring:message code="actor.confirm.delete"/>')"/>
		</jstl:when>
		<jstl:when test="${rol == 'Chapter'}">
			<acme:submit name="saveChapter" code="actor.save" onclick="javascript: return checkTelephone('${confirmTelephone}');"/>
			<input type="submit" name="deleteChapter" value="<spring:message code="actor.delete"/>" onclick="return confirm('<spring:message code="actor.confirm.delete"/>')"/>
		</jstl:when>
		<jstl:when test="${rol == 'Sponsor'}">
			<acme:submit name="saveSponsor" code="actor.save" onclick="javascript: return checkTelephone('${confirmTelephone}');"/>
			<input type="submit" name="deleteSponsor" value="<spring:message code="actor.delete"/>" onclick="return confirm('<spring:message code="actor.confirm.delete"/>')"/>
		</jstl:when>
	</jstl:choose>
