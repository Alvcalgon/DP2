		...
		<security:authorize access="hasRole('ADMIN')">
			<li><a class="fNiv"><spring:message	code="master.page.administrator" /></a>
				<ul>
					...
					<li><a href="process/administrator/launcher/display.do"><spring:message code="master.page.launcher.process" /></a></li>
				</ul>
			</li>
		</security:authorize>
		...
		<security:authorize access="hasRole('CHAPTER')">
			<li><a class="fNiv"><spring:message	code="master.page.chapter" /></a>
				<ul>
					...
					<li><a href="parade/chapter/list.do"><spring:message code="master.page.chapter.parades" /></a></li>
				</ul>
			</li>
		</security:authorize>
		...
		<security:authorize access="isAuthenticated()">
			...
			<li>
				...
				<ul>
					...
					<li><a href="box/administrator,brotherhood,chapter,member,sponsor/list.do"><spring:message code="master.page.box.list" /></a></li>
